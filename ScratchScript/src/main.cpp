...
ImTextureID draw_viewport(int width, int height, bool cleanup)
{
	...
	static const GLfloat vertices[] = { -0.5f, -0.5f, 0.0f, 0.0f, -0.5f, 0.5f, 0.0f, 1.0f, 0.5f, 0.5f, 1.0f, 1.0f, 0.5f, -0.5f, 1.0f, 0.0f };
...
int main(int argc, const char** argv)
{
	...
	io.Fonts->AddFontFromFileTTF("../res/fonts/Gothic3.ttf", 24);
	io.FontDefault = io.Fonts->AddFontFromFileTTF("../res/fonts/SpaceMono-Regular.ttf", 24);
	io.Fonts->AddFontFromFileTTF("../res/fonts/SpaceMono-Bold.ttf", 24);
	io.Fonts->AddFontFromFileTTF("../res/fonts/SpaceMono-BoldItalic.ttf", 24);
	io.Fonts->AddFontFromFileTTF("../res/fonts/SpaceMono-Italic.ttf", 24);
	io.Fonts->Build();
	...
	std::ifstream stream("../res/test/project.json");
	if (!stream.is_open())
	{
